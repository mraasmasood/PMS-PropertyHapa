...
namespace MagicVilla_Web.Services
{
    ...
    {
        public PMS_PropertyHapa.Owner.Models.APIResponse responseModel { get; set; }
        ...
        public async Task<T> SendAsync<T>(APIRequest apiRequest, bool withBearer = true)
        {
            try
            {
                ...
                PMS_PropertyHapa.Owner.Models.APIResponse FinalApiResponse = new()
                {
                    IsSuccess = false
                };
                ...
                try
                {
                    switch (httpResponseMessage.StatusCode)
                    {
                        ...
                        default:
                            ...
                            FinalApiResponse = JsonConvert.DeserializeObject<PMS_PropertyHapa.Owner.Models.APIResponse>(apiContent);
                            break;
                    }
                }
                catch (Exception e)
            ...
            {
                var dto = new PMS_PropertyHapa.Owner.Models.APIResponse
                {
        ...
        private async Task InvokeRefreshTokenEndpoint(HttpClient httpClient, string existingAccessToken, string existingRefreshToken)
        {
            ...
            var apiResponse = JsonConvert.DeserializeObject<PMS_PropertyHapa.Owner.Models.APIResponse>(content);
