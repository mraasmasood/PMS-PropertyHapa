if (localStorage.getItem("color"))
    $("#color").attr("href", "../Dashboard/assets/css/" + localStorage.getItem("color") + ".css");
...
$(document).ready(function () {
    $(".customizer-color li").on('click', function () {
        ...
        $("#color").attr("href", "../Dashboard/assets/css/" + color + ".css");
    ...
    if (localStorage.getItem("primaryColor") != null) {
        document.documentElement.style.setProperty('--theme-deafult', localStorage.getItem("primaryColor"));
    }
    if (localStorage.getItem("secondaryColor") != null) {
        document.documentElement.style.setProperty('--theme-secondary', localStorage.getItem("secondaryColor"));
    }
